...
const Links: React.FC = () => {
  return (
    <ul className="text-white text-4xl container px-4 justify-center  max-w-lg" >
      ...
      < li className="bg-[#252931AA] hover:bg-[#353941CC] py-2 rounded-full my-6 drop-shadow-[0_5px_3px_rgba(0,0,0,0.4)]" > <a className="flex items-center justify-center gap-3" href="https://www.msbarbieri.dev">
        <Image
          src="/home.svg"
          alt="Home Site"
          width={40}
